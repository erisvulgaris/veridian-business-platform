...
const businesses = [
  ...
  // === Additional businesses for richer discovery ===
  {
    name: 'Lifeline Diagnostics Center',
    tagline: 'Accurate diagnostics, faster decisions',
    description:
      'Lifeline Diagnostics is a NABL-accredited pathology and imaging center offering 2000+ tests including MRI, CT, digital X-ray, ultrasound and molecular diagnostics. Home sample collection available across the city with digital reports in 6 hours.',
    category: 'Clinics',
    verified: 'premium',
    rating: 4.6,
    reviewCount: 287,
    ...
    brandColor: '#0891b2',
    trending: true,
    subCategories: ['Pathology', 'Radiology', 'Health Packages'],
    languages: ['English', 'Hindi'],
    paymentMethods: ['Cash', 'Card', 'UPI', 'Insurance'],
    facilities: ['MRI', 'CT Scan', 'Ultrasound', 'Digital X-ray', 'Home collection'],
    deliveryOptions: ['Home sample collection', 'Digital reports'],
    certifications: ['NABL', 'ISO 9001'],
    awards: ['Best Diagnostic Center 2023'],
    products: [
      { name: 'Full Body Health Checkup (64 parameters)', category: 'Health Package', brand: 'Lifeline', priceMin: 2999, priceMax: 4999, availability: 'in_stock', featured: true, variants: ['Basic', 'Advanced', 'Premium'], specifications: [{ label: 'Parameters', value: '64' }, { label: 'Report time', value: '24 hours' }] },
    ],
    services: [
      { name: 'MRI Scan (3 Tesla)', pricing: '₹4,500 – ₹12,000', duration: '30–60 min', coverageArea: 'On-site', deliverables: ['Digital report', 'Film', 'Radiologist note'] },
      { name: 'Home Sample Collection', pricing: 'From ₹299', duration: '30 min slot', coverageArea: 'Citywide', deliverables: ['Phlebotomy', 'Digital report in 6h'] },
    ],
  },
  {
    name: 'Annapurna Organic Foods',
    tagline: 'Certified organic, farm to table',
    description:
      'Annapurna Organic Foods produces and distributes certified organic grains, pulses, spices and cold-pressed oils. Direct partnerships with 200+ organic farms, USDA and India Organic certified.',
    category: 'Manufacturers',
    verified: 'verified',
    rating: 4.4,
    reviewCount: 156,
  ...
  },
  {
    ...
    description:
      'Urban Brew is a specialty coffee roastery sourcing single-origin beans from Indian estates. Small-batch roasting, pour-over bar and barista training. B2B supply to cafes and hotels.',
    category: 'Manufacturers',
    verified: 'verified',
    rating: 4.8,
    reviewCount: 92,
    ...
    brandColor: '#92400e',
    trending: true,
    subCategories: ['Coffee', 'Beverages', 'Cafe Supply'],
    languages: ['English', 'Hindi'],
    ...
    certifications: ['FSSAI'],
    products: [
      { name: 'Arabica Estate Coffee Beans 1kg', category: 'Coffee', brand: 'Urban Brew', priceMin: 680, priceMax: 850, availability: 'in_stock', featured: true, variants: ['Light roast', 'Medium roast', 'Dark roast', 'Espresso blend'], specifications: [{ label: 'Origin', value: 'Coorg' }, { label: 'Roast date', value: 'Within 7 days' }] },
      { name: 'Cold Brew Concentrate 1L', category: 'Coffee', brand: 'Urban Brew', priceMin: 320, priceMax: 380, availability: 'in_stock', variants: ['500ml', '1L'], specifications: [{ label: 'Shelf life', value: '30 days refrigerated' }] },
    ],
    services: [
      { name: 'Barista Training Workshop', pricing: '₹3,500/person', duration: '4 hours', coverageArea: 'On-site', deliverables: ['Hands-on training', 'Certificate', 'Coffee kit'] },
    ],
  },
  {
    name: 'TechHub Electronics Wholesale',
    tagline: 'Bulk electronics & accessories distributor',
    description:
      'TechHub is a leading B2B distributor of mobile accessories, computer peripherals and smart home devices. Authorized distributor for 30+ brands, serving 4000+ retailers with next-day delivery.',
    category: 'Wholesalers',
    verified: 'premium',
    rating: 4.3,
    reviewCount: 198,
    ...
    teamSize: '85',
    brandColor: '#4338ca',
    subCategories: ['Electronics', 'Accessories', 'Smart Home'],
    languages: ['English', 'Hindi'],
    paymentMethods: ['NEFT', 'RTGS', 'Credit'],
  ...
  {
    name: 'GreenLeaf Landscapes & Nursery',
    tagline: 'Designing living spaces, naturally',
    description:
      'GreenLeaf offers landscape design, installation and maintenance for residential and commercial properties. In-house nursery with 500+ plant species, vertical garden systems and smart irrigation.',
    category: 'Real Estate',
    verified: 'verified',
    rating: 4.5,
    reviewCount: 78,
    ...
    brandColor: '#15803d',
    recentlyVerified: true,
    subCategories: ['Landscaping', 'Nursery', 'Vertical Gardens'],
    languages: ['English', 'Hindi'],
    paymentMethods: ['Cash', 'UPI', 'Cheque'],
    facilities: ['Nursery', 'Design studio', 'Tool depot'],
    deliveryOptions: ['Site visits', 'Plant delivery'],
    certifications: ['ISO 9001'],
    products: [
      { name: 'Indoor Air-Purifying Plant Set (5 plants)', category: 'Plants', brand: 'GreenLeaf', priceMin: 899, priceMax: 1499, availability: 'in_stock', variants: ['3 plants', '5 plants', '10 plants'], specifications: [{ label: 'Includes', value: 'Pots + soil' }] },
      { name: 'Vertical Garden Module (1 sqm)', category: 'Landscaping', brand: 'GreenLeaf', priceMin: 2200, priceMax: 3500, availability: 'made_to_order', variants: ['1sqm', '2sqm', 'Custom'], specifications: [{ label: 'Plants/sqm', value: '16' }, { label: 'Irrigation', value: 'Auto drip' }] },
    ],
    services: [
      { name: 'Landscape Design Consultation', pricing: '₹2,500/session', duration: '2 hours', coverageArea: 'Citywide', deliverables: ['Site survey', '3D design', 'Quote'] },
      { name: 'Garden Maintenance (Monthly)', pricing: '₹3,000 – ₹8,000/month', duration: 'Ongoing', coverageArea: 'Citywide', deliverables: ['Pruning', 'Fertilizing', 'Pest control'] },
    ],
  },
  {
    name: 'Spice Route Fine Dining',
    tagline: 'A journey through regional Indian cuisine',
    description:
      'Spice Route is an award-winning restaurant celebrating the diverse culinary traditions of India. From Kashmiri wazwan to coastal Kerala cuisine, each dish is crafted with heirloom recipes and locally-sourced spices.',
    category: 'Restaurants',
    verified: 'verified',
    rating: 4.6,
    reviewCount: 543,
    ...
    brandColor: '#c2410c',
    featured: true,
    subCategories: ['Fine Dining', 'Indian', 'Regional'],
    languages: ['English', 'Hindi'],
    paymentMethods: ['Cash', 'Card', 'UPI'],
    facilities: ['Private dining', 'Bar', 'Valet', 'Outdoor seating'],
    deliveryOptions: ['In-house', 'Delivery partners'],
    certifications: ['FSSAI'],
    awards: ['Best Regional Cuisine 2023'],
    products: [],
    services: [
      { name: 'Chef\'s Tasting Menu (9 courses)', pricing: '₹4,500 per person', duration: '2.5 hours', coverageArea: 'On-site', deliverables: ['Curated menu', 'Pairing optional'] },
      { name: 'Private Dining (up to 20 guests)', pricing: '₹75,000 + taxes', duration: 'Per event', coverageArea: 'On-site', deliverables: ['Private room', 'Custom menu', 'Dedicated staff'] },
    ],
  },
  {
    name: 'CityCare Veterinary Hospital',
    tagline: 'Compassionate care for your companions',
    description:
      'CityCare is a full-service veterinary hospital offering preventive care, surgery, dental, dermatology and emergency services for companion animals. In-house lab, digital radiography and a comfortable recovery ward.',
    category: 'Hospitals',
    verified: 'verified',
    rating: 4.7,
    reviewCount: 234,
    ...
    teamSize: '22',
    brandColor: '#0d9488',
    subCategories: ['Veterinary', 'Surgery', 'Emergency'],
    languages: ['English', 'Hindi'],
    paymentMethods: ['Cash', 'Card', 'UPI'],
    facilities: ['Surgery suite', 'Digital X-ray', 'In-house lab', 'Recovery ward', 'Pharmacy'],
    deliveryOptions: ['Teleconsultation'],
    certifications: ['VCI Registered'],
    products: [],
    services: [
      { name: 'Annual Wellness Checkup (Dog/Cat)', pricing: '₹1,200 – ₹2,500', duration: '45 min', coverageArea: 'On-site', deliverables: ['Physical exam', 'Vaccines', 'Lab panel'] },
      { name: 'Emergency & Critical Care', pricing: 'From ₹2,000', duration: '24/7', coverageArea: 'On-site', deliverables: ['Triage', 'Stabilization', 'Monitoring'] },
    ],
  },
  {
    ...
    description:
      'Solaris designs and installs rooftop solar systems for homes, businesses and industries. End-to-end service from site assessment to grid connection, with 25-year performance warranties and financing options.',
    category: 'Industrial Machinery',
    verified: 'premium',
    rating: 4.5,
    reviewCount: 167,
    ...
    brandColor: '#ca8a04',
    trending: true,
    subCategories: ['Solar', 'Renewable Energy', 'Installation'],
    languages: ['English', 'Hindi'],
    ...
    products: [
      { name: 'Rooftop Solar System 5kW (Residential)', category: 'Solar', brand: 'Solaris', priceMin: 250000, priceMax: 320000, availability: 'made_to_order', featured: true, variants: ['3kW', '5kW', '10kW', '25kW'], specifications: [{ label: 'Panels', value: 'Mono PERC 550W' }, { label: 'Inverter', value: 'String' }, { label: 'Warranty', value: '25 years' }] },
      { name: 'Solar Water Heater 200L', category: 'Solar', brand: 'Solaris', priceMin: 18000, priceMax: 24000, availability: 'in_stock', variants: ['100L', '200L', '300L'], specifications: [{ label: 'Type', value: 'Evacuated tube' }] },
    ],
    services: [
